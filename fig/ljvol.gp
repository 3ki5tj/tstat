...
set ytics 0.1 
set ylabel "Pressure {/Arial-Italic p}{/=6 &.}({/Arial-Italic n}{/=6 &.})" offset 2.5, 0
set yrange [:0.3]
set key left top
set ytics nomirror
set my2tics 5
set y2tics 5 font tcfont offset -0.7, 0
set y2label "{/Arial-Italic G} = {/Arial-Italic F}{/=6 &.}({/Arial-Italic V}{/=8 &.}) + {/Arial-Italic p^*}{/=6 &.}{/Arial-Italic V}" offset -2., 0
set y2range[:15]

set rmargin 5.5

set label "{/Arial-Italic p}^* = 0.0696" at 0.41, 0.09
sh = 0.2
plot [.05:.7][] \
  0.0696 w l lt 4 not, \
